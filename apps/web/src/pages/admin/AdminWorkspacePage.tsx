...
type CellKind = 'text' | 'date' | 'datetime' | 'currency' | 'status' | 'boolean' | 'number' | 'rating'
...
const RESOURCE_CONFIGS: Record<AdminSectionId, ResourceConfig> = {
  ...
  users: {
    ...
    fields: [
      ...
      { name: 'role', label: 'Role', kind: 'select', required: true, options: [{ label: 'Student', value: 'student' }, { label: 'Driver', value: 'driver' }, { label: 'Conductor', value: 'conductor' }, { label: 'Administrator', value: 'admin' }] },
      { name: 'identifier', label: 'Student / employee ID', kind: 'text', required: true },
    ...
    filters: [
      { name: 'role', label: 'All roles', options: [{ label: 'Students', value: 'student' }, { label: 'Drivers', value: 'driver' }, { label: 'Conductors', value: 'conductor' }, { label: 'Administrators', value: 'admin' }] },
